...
class HueMenuController(
    private val activity: AppCompatActivity,
    val hueController: HueLightController,
    val hueStore: HueCredentialStore,
    private val systemAudioProvider: () -> Boolean,
    private val updateAdvancedVisibilityDelegate: () -> Unit
) {
    private val btnHueConnect: Button = activity.findViewById(R.id.btn_hue_connect)
    private val btnHueSync: Button = activity.findViewById(R.id.btn_hue_sync)
    private val btnHueForget: Button = activity.findViewById(R.id.btn_hue_forget)
    private val huePrerequisites: View = activity.findViewById(R.id.hue_prerequisites)
    private val hueAreaSection: LinearLayout = activity.findViewById(R.id.hue_section_areas)
    private val hueAreaContainer: LinearLayout = activity.findViewById(R.id.hue_area_container)
    private val hueSyncSection: LinearLayout = activity.findViewById(R.id.hue_section_sync)
    private val hueStatus: TextView = activity.findViewById(R.id.hue_status)
    private val hueConn: TextView = activity.findViewById(R.id.hue_conn)
    ...
    fun refreshHueAfterResume(backgroundedAtMs: Long) {
